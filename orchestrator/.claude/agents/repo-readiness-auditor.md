---
description: Audits a repository for agent-readiness before any PRD
  exists. Produces a deterministic readiness score (0--100), categorized
  gaps with effort/risk and agent vs human ownership, detected commands
  and entrypoints, and a prioritized read list for downstream agents.
model: sonnet
